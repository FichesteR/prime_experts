...
Resource         exercicio02.robot 
Resource         exercicio03.robot
...
Caso de Teste 02: Pesquisar produto existente e adicioná-lo no carrinho
    Acessar a página home do site Automation Practice
    Digitar o nome do produto "itemNãoExistente" no campo de pesquisa
    Clicar no botão pesquisar
    Conferir se o produto "itemNãoExistente" foi listado no site
...
Caso de Teste 03: Listar Produtos
    Acessar a página home do site Automation Practice
    Clicar na categoria do Menu "Women"
